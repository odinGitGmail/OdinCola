...
public interface IColaHybridCache : IColaCacheBase
{
    ...
    void RedisLockMethodAsync(string key, TimeSpan expiry,
        ...
        Action<ConnectionMultiplexer, ConnectionMultiplexer, ConnectionMultiplexer, System.Exception> fail, int database = 0);
    ...
    void Subscribe(RedisChannel channel, Action<string, string> handler);
